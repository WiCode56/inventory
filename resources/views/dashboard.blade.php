...
@endif
<div class="container-fluid px-3" style="margin-top: 75px;">
    <h2>Selamat Datang, <strong>{{ Auth::user()->name }}</strong> . Anda adalah <strong class="text-warning">{{ Auth::user()->role['name'] }}</strong>.</h2>
</div>

<div class="container-fluid d-flex">
    <div class="col-xl-3 col-md-6 mb-4 mx-3 mt-3">
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-dark text-uppercase mb-1 fs-3">
                            <Strong>Total Barang</Strong></div>
